...
const ExperienceSection = () => {
  const experiences = [{
    ...
    technologies: ["Power BI", "Python", "SQL", "Excel", "Statistical Analysis", "Business Intelligence", "ETL/ELT", "Requirement Gathering & Documentation", "Cross-functional Communication", "Problem Solving Skills"]
  }, {
    id: 2,
