...
const ExperienceSection = memo(() => {
  const experiences = [{
    ...
    technologies: ["Power BI", "Python", "SQL", "Excel", "Statistical Analysis", "Business Intelligence", "ETL/ELT", "Requirement Gathering & Documentation", "Cross-functional Communication", "Problem Solving Skills", "DevOps & Infrastructure", "PMO", "Automation", "AI/ML"]
  }, {
    id: 2,
    ...
    technologies: ["Project Management", "Excel", "Stakeholder Management", "Requirement Gathering & Documentation", "Cross-functional Communication"]
  }, {
    id: 3,
    ...
    achievements: ["Developed proficiency in business analysis and statistical methods", "Gained expertise in business finance and customer insight analysis", "Built strong foundation in project management practices", "Mastered analytical skills and marketing strategy development"],
