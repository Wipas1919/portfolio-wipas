...
import { ArrowLeft, Github, Database, BarChart3, Cloud, Workflow, Expand, Mail, Phone, Linkedin } from "lucide-react";
          ...
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Button size="lg" asChild>
                <a href="https://github.com/Wipas1919/End-to-End-DE" target="_blank" rel="noopener noreferrer">
